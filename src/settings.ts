...
window.onload = () => {
  ...
  $("#user-settings")
    .append($("<div>")
    .html("Welcome " + currentUser)).append("<br><br>");
  $("#user-settings")
    .append($("<div>")
    .attr("id", "homepage")
      .append($("<div>")
    ...
    .append($("<form>").attr("onsubmit", "event.preventDefault()")
      .attr("id", "homepage-form")
        ...
        .append($("<input>").attr("value", "new-homepage2").attr("type", "radio")
          .attr("name", "newTabCreation")).append("Blank page").append("<br>")
        .append($("<input>").attr("value", "new-homepage3").attr("type", "radio")
          .attr("name", "newTabCreation")).append("athenaNet"));
  $("#user-settings")
    .append($("<button>")
